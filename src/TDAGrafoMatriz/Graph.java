...
public interface Graph<V,E> {
	...
	/**
	 * Devuelve una colección iterable de arcos emergentes a un vértice v.
	 * @param v Un vértice.
	 * @return Una colección iterable de arcos emergentes a un vértice v.
	 * @throws InvalidVertexException si el vértice es inválido.
	 */
	...
	/**
	 * Devuelve un Arreglo de 2 elementos con los vértices extremos de un Arco e.
	 * @param  e Un arco
	 ...
	 * @param e Un arco.
	 * @param x un rótulo.
	 * @return El rótulo anterior del arco e.
	 * @throws InvalidEdgeException si el arco es inválido.
	 */
