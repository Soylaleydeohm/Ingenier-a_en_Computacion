 ...
 * @param <E> Parámetro formal de tipo que representa el tipo de los elementos de ListaDoblementeEnlazada.
 */
public class ListaDoblementeEnlazada<E> implements PositionList<E>{
	...
	/**
	 * Verifica que la posición pasada por parámetro sea válida.
	 * @param p Posición a verificar.
	 * @return La posición si es válida.
