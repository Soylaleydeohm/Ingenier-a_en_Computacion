...
public interface BinaryTree<E> extends GTTree<E>
{
	 ...
	 * @return Posición de la raíz que se creó.
	 ...
	 * @param r rótulo de la nueva raíz.
	 * @param T1 árbol binario a insertar como hijo izquierdo de r.
	 * @param T2 árbol binario a insertar como hijo derecho de r. 
