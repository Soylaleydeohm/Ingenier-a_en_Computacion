...
public class ListaEnlazadaIterable<E> implements PositionListIterable<E>{
	...
	public Iterable<Position<E>> positions(){//Retorna una colección de los nodos de la lista
		PositionListIterable<Position<E>> p = new ListaEnlazadaIterable<Position<E>>();
		try{
			if(!isEmpty()){
		...
		}catch(EmptyListException e){System.out.println("Lista vacía");
		}catch(InvalidPositionException e){System.out.println("Posición inválida");
		}catch(BoundaryViolationException e){System.out.println("Posición excede los límites de la lista");
		}
		return p;
	}
